  ...
  children: [
    {
      ...
      controls: [
        { kind: 'range', uniform: 'uStarSize',  label: 'StarSize',  min: 0.01,  max: 0.2, step: 0.001 },
    ...
    },
    {
      ...
      controls: [
        { kind: 'range', uniform: 'uScale',          label: 'Scale',          min: 2,     max: 10,  step: 1     },
        { kind: 'range', uniform: 'uStarSize',       label: 'StarSize',       min: 0.01,  max: 0.5, step: 0.001 },
        { kind: 'range', uniform: 'uLineWidth',      label: 'LineWidth',      min: 0.002, max: 0.1, step: 0.001 },
        { kind: 'range', uniform: 'uLineBrightness', label: 'LineBrightness', min: 0.0,   max: 1.0, step: 0.01  },
        { kind: 'color', uniform: 'uBaseColor',      label: 'BaseColor' },
      ],
    },
  ],
