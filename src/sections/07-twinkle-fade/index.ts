...
export const section07: SectionConfig = {
  ...
  return bStatic * mix(1.0 - uTwinkleAmount, 1.0, pulse);
      ...
      controls: [
        { kind: 'range',  uniform: 'uTwinkleSpeed',     label: 'TwinkleSpeed',     min: 0.0,   max: 4.0, step: 0.05  },
        { kind: 'range',  uniform: 'uTwinkleAmount',    label: 'TwinkleAmount',    min: 0.0,   max: 1.0, step: 0.01  },
...
lines += smoothstep(w2eff, 0.0, distToSeg2(grid, me, nb))
      ...
      controls: [
        { kind: 'range',  uniform: 'uLineFadeNear',     label: 'LineFadeNear',     min: 0.0,   max: 1.5, step: 0.01  },
        { kind: 'range',  uniform: 'uLineFadeFar',      label: 'LineFadeFar',      min: 0.2,   max: 3.0, step: 0.01  },
        { kind: 'range',  uniform: 'uLineDensity',      label: 'LineDensity',      min: 0.0,   max: 1.0, step: 0.01  },
        { kind: 'range',  uniform: 'uBrightnessWeight', label: 'BrightnessWeight', min: 0.0,   max: 1.0, step: 0.01  },
        { kind: 'range',  uniform: 'uDistanceWeight',   label: 'DistanceWeight',   min: 0.0,   max: 1.0, step: 0.01  },
        { kind: 'range',  uniform: 'uMinBrightness',    label: 'MinBrightness',    min: 0.0,   max: 1.0, step: 0.01  },
